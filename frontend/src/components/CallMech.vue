<template>
  <div class="pa-4 px-lg-16 px-xl-16 mx-lg-auto mx-xl-auto">
    ...
    <v-card text-left pa-4 d-flex justify-left align-center class="rounded-lg elevation-4">
      ...
      <v-card @click="locatorButtonPressed()" class="text-left pa-4 d-flex justify-left align-center">
        <section>
    ...
    <v-dialog v-model="selectCarModal" width="800">
      <v-card>
        ...
        <v-divider></v-divider>
        <v-card-action>
          <v-btn block color="blue-darken-1" prepend-icon="mdi-plus" @click="dialog2 = true">Add new preset</v-btn>
        </v-card-action>
      </v-card>
    </v-dialog>
    ...
    <section class="text-center">
      <div class="text-decoration-none" @click= "addTicket()"
        ><v-btn class="mx-1" variant="tonal" color="blue-darken-2" 
          >Find Service</v-btn
        ></div
      >
    </section>
