...
// CustomerByEmail is the resolver for the customerByEmail field.
func (r *queryResolver) CustomerByEmail(ctx context.Context, input string) (*model.Customer, error) {
	result, err := r.DB.CustomerFindByEmail(ctx, input)
	return result, err
}
