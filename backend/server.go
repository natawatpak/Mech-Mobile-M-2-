...
func main() {
	...
	if runtime_api, _ := os.LookupEnv("AWS_LAMBDA_RUNTIME_API"); runtime_api != "" {
		// config
		var host string = "mechmobiledb.cq0xcdpdhelw.us-east-1.rds.amazonaws.com" //IP
		var port string = "5432"                                                  //port
		var user string = "postgres"                                              //root user
		var password string = "posgresadmin"                                      //root pass
		var dbname string = "mechmobiledb"                                        //dbname
